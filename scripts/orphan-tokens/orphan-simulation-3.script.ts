// npx hardhat run scripts/orphan-tokens/orphan-simulation-3.script.ts --network hardhat
/**
 * Similar to Simulation 2 but with a steeper price slope
 *
 * This simulates a large refund scenario with orphaned tokens PLUS a huge price slope
 * 1st buyer buys 600k USDT + 600k USDT but refunds first 600k USDT
 * 2nd buyer buys 600k USDT
 * 3rd buyer buys remaining amount
 *
 * We are left with 10M orphaned tokens (25% of total 40M tokens allocated for buyers)
 * This reflects how steeper price curves can lead to more orphaned tokens
 *
 */
...
async function main() {
  ...
  // P2: Buyer 2's 600k purchase
  console.log("\nP2: Buyer 2's 600k USDT purchase");
