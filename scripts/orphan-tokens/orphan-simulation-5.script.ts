// npx hardhat run scripts/orphan-tokens/orphan-simulation-5.script.ts --network hardhat
/**
 * Similar to Simulation 3 steep price slope, but with more refunds
 *
 ...
 *
 * We are left with 12.3M orphaned tokens (30% of total 40M tokens allocated for buyers)
