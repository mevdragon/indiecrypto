// npx hardhat run scripts/orphan-tokens/orphan-simulation-8.script.ts --network hardhat
/**
 *
 * Similar to Simulation 2 but with less rake
 *
 * This simulates a large refund scenario with orphaned tokens
 * 1st buyer buys 600k USDT + 600k USDT but refunds first 600k USDT
 * 2nd buyer buys 600k USDT
 * 3rd buyer buys remaining amount
 *
 * We are left with 14.2M orphaned tokens (20.8% of total 68M tokens allocated for buyers)
