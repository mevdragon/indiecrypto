// npx hardhat run scripts/early-deploy/early-deploy-simulation-1.script.ts --network hardhat

/**
 * This script simulates a premature deployment scenario with $1M from 5 buyers & middle refunds to net $400k raised
...
async function main() {
  ...
  // First 5 buyers purchase 10% each
  for (let i = 0; i < 5; i++) {
